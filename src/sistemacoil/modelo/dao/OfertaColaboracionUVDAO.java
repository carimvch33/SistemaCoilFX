...
public class OfertaColaboracionUVDAO {
    ...
    public static HashMap<String, Object> obtenerOfertasUVProfesorUV(Integer idProfesorUV){
        ...
        if(conexionBD != null){
            try{
                String consulta = "SELECT idOfertaColaboracionUV, nombreColaboracion, idExperienciaEducativa, "
                        + "objetivoCurso, perfilEstudiante, temaInteres, informacionAdicional, "
                        + "estado, o.idIdioma, i.nombre AS 'idioma', o.idAreaAcademica, a.nombre "
                        + "AS 'areaAcademica', o.idDependencia, d.nombre "
                        + "AS 'dependencia', o.idPeriodo, p.nombrePeriodo "
                        + "AS 'periodo', o.idProfesorUV FROM ofertacolaboracionuv o "
                        ...
                        + "INNER JOIN profesoruv pr ON o.idProfesorUV = pr.idProfesorUV "
                        + "WHERE o.idProfesorUV = ?";
